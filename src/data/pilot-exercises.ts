    ...
    nodes: [
      {
        ...
        choices: [
          ...
          'Je vais la transmettre après avoir vérifié que nous travaillons dans la même organisation.',
          'Je vais vous en résumer le contenu sans vous envoyer le document.',
          'Je vais demander au fournisseur si je peux vous la partager.',
        ],
...
const a10BestResponses: BestResponseExercise[] = [
  {
    ...
    distractors: [
      'Nadia vérifiera les chiffres jeudi matin.',
      'Élodie vérifiera le dossier jeudi matin.',
      'Élodie vérifiera les chiffres vendredi matin.',
    ],
  ...
  },
  {
    ...
    kind: 'best-response',
    situation: 'Vous répartissez un rapport entre deux collègues. Vous prenez la première partie et Nadia doit s’occuper des annexes.',
    prompt: 'Quelle formulation annonce exactement cette répartition?',
    answer: 'Je prépare la première partie et Nadia s’occupera des annexes.',
    distractors: [
      'Nadia prépare la première partie et je m’occupe des annexes.',
      'Je prépare les annexes et Nadia s’occupe de la première partie.',
      'Je prépare la première partie et Nadia relira le rapport.',
    ],
  ...
  },
  {
    ...
    kind: 'best-response',
    situation: 'Une collègue doit terminer sa partie avant une réunion. Vous voulez la recevoir jeudi midi et lui donnez une consigne polie.',
    prompt: 'Quelle demande indique exactement cette échéance?',
    answer: 'Pourriez-vous me remettre votre partie d’ici jeudi midi?',
    distractors: [
      'Pourriez-vous me remettre votre partie d’ici vendredi midi?',
      'Pourriez-vous remettre votre partie à Nadia d’ici jeudi midi?',
      'Pourriez-vous me remettre le dossier d’ici jeudi midi?',
    ],
  ...
  },
  {
    ...
    kind: 'best-response',
    situation: 'Un nouveau membre rejoint l’équipe. Il doit traiter d’abord les demandes urgentes, puis transmettre le reste à l’équipe.',
    prompt: 'Quelle instruction indique exactement cette séquence?',
    answer: 'Commencez par les demandes urgentes, puis transmettez le reste à l’équipe.',
    distractors: [
      'Commencez par le dossier partagé, puis transmettez les demandes urgentes à l’équipe.',
      'Transmettez d’abord les demandes urgentes à l’équipe, puis traitez le reste.',
      'Commencez par les demandes urgentes, puis conservez le reste sans le transmettre.',
    ],
...
const c16Responses: (BestResponseExercise | TransformationExercise)[] = [
  {
    ...
    distractors: [
      'Je vais conserver les notes seulement jusqu’à la fin de la semaine.',
      'Je vais archiver les notes sans vérifier la règle applicable.',
      'Je vais demander au collègue de décider quoi conserver.',
    ],
  ...
  },
  {
    ...
    distractors: [
      'Je vais déclarer ce lien après avoir noté la proposition.',
      'Je vais demander à un collègue de vérifier la proposition sans déclarer ce lien.',
      'Je vais continuer l’évaluation en indiquant seulement que je connais le secteur.',
    ],
